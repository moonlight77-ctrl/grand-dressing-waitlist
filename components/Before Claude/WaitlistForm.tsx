...
export default function WaitlistForm() {
  ...
  if (step === 'qualifying') {
    ...
    return (
      <div className="max-w-lg mx-auto bg-neutral-900/50 backdrop-blur-md border border-amber-200/10 p-6 md:p-10 animate-in fade-in zoom-in duration-500">
        <div className="text-center mb-6">
          <p className="font-sans text-xs uppercase letter-spacing-luxury tracking-[0.2em] text-amber-200 mb-2">
  ...
  if (step === 'referral') {
    return (
      <div className="max-w-lg mx-auto bg-neutral-900/50 backdrop-blur-md border border-amber-200/10 p-8 md:p-12 animate-in fade-in zoom-in duration-500">
        <div className="text-center mb-6">
          <Check className="w-8 h-8 text-amber-200 mx-auto mb-3" strokeWidth={1.2} />
